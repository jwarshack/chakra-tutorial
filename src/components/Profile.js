...
function Profile() {
    ...
    return (
        <Flex direction={isNotSmallerScreen ? "row" : "column"} w="100%" maxWidth={{base: "100vh", md: "130vh", lg: "130vh", xl: "130vh"}}>
            ...
            <Box alignSelf="center" px="32" py="16">
                <Text fontWeight="bold" fontSize="2xl">Product Designer and Developer, specialized in Web3 technologies.</Text>
                <Flex direction={isNotSmallerScreen ? "row" : "column"} mt={8}>
                    ...
                    <Flex rounded="xl" direction="column" mt={4} ml={isNotSmallerScreen ? 4 : 0} bg="gray.400" h="30vh" w="30vh" justify="flex-end">
                    ...
                    <Flex rounded="xl" direction="column" mt={4} ml={isNotSmallerScreen ? 4 : 0} bg="gray.100" h="30vh" w="30vh" justify="flex-end" _hover={{ bg: "green.400" }}>
                        <Icon as={DiWebplatform} p="4" w="24" color="black"/>
                        <Text color="black" p="4" w="24" color="black">
                            Web Apps
                        </Text>
